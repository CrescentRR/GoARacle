...
-Download the usable version at https://mega.nz/file/eE5zUQyA#YqFkKKYIiYRbtyu3JUOmmiZ1zTxfmro76VFKmhAh8UM and clicking on the path "GoARacle", then pressing the Download button to download the whole folder.  Extract the folder and launch "GoARacle.exe", which is the application with the blue crystal icon.
