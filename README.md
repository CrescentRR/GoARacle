...
Honestly, it's pretty discouraging.  I spend my time making something for people to enjoy, and no one uses it.  Not just from unawareness, but from not wanting to use it.  Why install a program from some random a-hole on the internet when you could just use the easily accessable website pinned in the resources tab.  Part of me wants to keep updating, keep improving this until someone gives this the time of day.  The other part just wants me to realize that this will never take off like I hope it would've.  Who fucking knows at this rate.  Might as well just start learning JavaScript so I could even hope to compete.  Or just give up entirely, that sounds easier, and god knows that I'm really fucking good at taking the easy path.  Lesson learned, I guess.  Don't get involved in a community, you'll feel rejected when you notice they don't want you.
